...
def original_predict(args):
    ...
    model.load_weights("/media/dy/Data_2T/CGP/Unet_Segnet/MICCAI/model/kidney/2/" + args["model"])
    for n in range(len(TEST_SET)):
        ...
        mask_whole[:,:] = pred[:,:]
        cv2.imwrite('/media/dy/Data_2T/CGP/Unet_Segnet/MICCAI/result/mask/kidney/2/'+path,mask_whole[0:h,0:w])
