...
# construct the argument parse and parse the arguments
    ...
    ap.add_argument("--Imagepath", required=True, help="path of your predic mask")
    ap.add_argument("--Labelpath", required=True, help="path of your ground-truth mask")
    ap.add_argument("--Savepath", required=True, help="path to save your results")
